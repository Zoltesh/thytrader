...
- [Delivery roadmap](roadmap.md) — Phases 0–8 shipped slice (Phase 8 = research HTF filter); **Phases 9–14** next for iterative Builder work
...
- [Agent-driven platform gap plan (2026-09-12)](plans/2026-09-12-agent-driven-platform-gap-plan.md) — accepted as roadmap Phases 7–14 (Phase 7 datasets, Phase 7.1 research fees, and Phase 8 research HTF filter are shipped; later phases are not)
