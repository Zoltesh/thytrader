...
- [Delivery roadmap](roadmap.md) — Phases 0–8 shipped slice (Phase 8 = research HTF filter); **Phase 9 first two indicator slices shipped** (`highest`/`lowest`/`stdev`, then `roc`/`williams_r`/`cci`); **Phases 9 remaining–14** next for iterative Builder work
...
- [Agent-driven platform gap plan (2026-09-12)](plans/2026-09-12-agent-driven-platform-gap-plan.md) — accepted as roadmap Phases 7–14 (Phase 7 datasets, Phase 7.1 research fees, Phase 8 research HTF filter, and Phase 9 first two indicator slices are shipped; later phases are not)
