...
| Workstation IA | First-class Strategies, Backtests, Research, Deploy, Trade, Journals, Chat, Audit, Memory, and Settings ([ADR 0053](decisions/0053-workstation-ia-write-only-coinbase-credentials.md)). Library drawer is Insight/Versions; research and paper/live open their own pages | Keep those surfaces uncluttered. Do not weaken safety copy or confirmation. YAML/YOLO stays the ADR 0055 panel beside Coinbase credentials |
