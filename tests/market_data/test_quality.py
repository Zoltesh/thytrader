...
def test_missing_interval_starts_lists_absent_thirty_minute_bars() -> None:
    """30m gap inspection lists missing starts without interpolating prices."""
    starts_at = datetime(2026, 7, 28, 0, 0, tzinfo=UTC)
    ends_at = datetime(2026, 7, 28, 1, 30, tzinfo=UTC)
    present = (
        Candle(
            starts_at=starts_at,
            open=Decimal("100"),
