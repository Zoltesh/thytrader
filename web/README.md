...
requests to the local FastAPI process at `127.0.0.1:8200` during development. Portfolio history
and backtest equity curves use the pinned `lightweight-charts` canvas library.
