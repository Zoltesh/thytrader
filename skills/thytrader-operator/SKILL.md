...
3. Gather only the extra report needed (market-data, strategies, performance, reconciliation).
...
7. Stop. Draft/publish/backtest require `skills/thytrader-research/SKILL.md` and `--confirm`. Deploy, pause, resume, stop, and live arming are out of scope.
