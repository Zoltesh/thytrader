...
- `thytrader-runtime` — paper/live start/pause/resume/stop, on-demand `place-order`, and risk-policy publication (`--confirm`; live start and live place-order also `--i-understand-live`)
